...
class WebSocketPoseTransformer:
    ...
    async def dummy_transform(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        transform_matrix = [[1.0729983014292432, -0.23928697532873258, -0.021489534457969306], [-0.0004619049893227412, 1.0820835004833012, -0.10001138385158313], [0.045311155437659976, -0.3852524987029172, 1.0]]
        transform_matrix = [[0.9613565003778314, -0.19570249202274037, 0.14175917985994052], [0.03539043672533831, 0.798600164944313, 0.033105962162332296], [0.07812376501156348, -0.3014854859105936, 1.0]]
