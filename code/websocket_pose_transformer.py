...
class WebSocketPoseTransformer:
    ...
    async def dummy_transform(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        transform_matrix = [[1.1037377050955517, -0.22196538482187758, -0.04186759207349692], [-0.019138685211431035, 1.124706453274771, -0.0969283271140223], [0.03754716822851461, -0.3389801608093725, 1.0]]
