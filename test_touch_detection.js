...
function testTouchDetection() {
  ...
  console.log('\nTest 2: Left hand near hold1');
  console.log('==============================');
  // Calculate relative position for hold1 (125, 125) in SVG coordinates
  const hold1RelativeX = 125 / 1000; // Approximate relative position
  const hold1RelativeY = 125 / 1000;
  const landmarks2 = createPoseLandmarks(hold1RelativeX, hold1RelativeY, 0.8, 0.8);
  ...
  setTimeout(() => {
    ...
    console.log('\nTest 3: Right hand near hold2');
    console.log('===============================');
    // Calculate relative position for hold2 (325, 325) in SVG coordinates
    const hold2RelativeX = 325 / 1000;
    const hold2RelativeY = 325 / 1000;
    const landmarks3 = createPoseLandmarks(0.2, 0.2, hold2RelativeX, hold2RelativeY);
